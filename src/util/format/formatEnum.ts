...
export const formatAqiFeedbackState = (state: AqiFeedbackState): string => {
  switch (state) {
    case AqiFeedbackState.Unassigned:
      return '未指派'
    case AqiFeedbackState.Assigned:
      return '已指派'
    case AqiFeedbackState.Completed:
      return '已完成'
    default:
      return '未知状态'
  }
...
export const formatTaskCompletedState = (state: TaskCompletedState): string => {
  switch (state) {
    case TaskCompletedState.Uncompleted:
      return '未完成'
    case TaskCompletedState.Completed:
      return '已完成'
    case TaskCompletedState.CrossDomainRequesting:
      return '跨域请求中'
    case TaskCompletedState.CrossDomainRequestDenied:
      return '跨域请求被拒'
    case TaskCompletedState.CrossDomainRequestAccepted:
      return '跨域请求被接受'
    case TaskCompletedState.CrossDomainRequestCompleted:
      return '跨域请求完成'
    default:
      return '未知状态'
  }
...
export const formatLeaveRequestState = (state: LeaveRequestState): string => {
  switch (state) {
